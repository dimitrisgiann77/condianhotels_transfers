const DICT = {
  el: {
    ...
    map_tab: 'Χάρτης', days_label: 'Διάλεξε ημέρες', days_hint: 'Διάλεξε όσες ημέρες θες να δηλώσεις με το ίδιο σημείο/δρομολόγιο.', choose_on_map: 'Διάλεξε το σημείο παραλαβής σου στον χάρτη', or_list: 'ή διάλεξε από λίστα', seats_word: 'θέσ.', map_view_hint: 'Πινέζες με τις ώρες που περνά το λεωφορείο. Κάνε κλικ για λεπτομέρειες.', selected_pickup: 'Επιλεγμένο pick up', clear_sel: 'Καθαρισμός', no_points_map: 'Δεν υπάρχουν σημεία στον χάρτη ακόμη.',
  ...
  en: {
    ...
    map_tab: 'Map', days_label: 'Choose days', days_hint: 'Select as many days as you want, all with the same point/route.', choose_on_map: 'Pick your pickup point on the map', or_list: 'or choose from a list', seats_word: 'seats', map_view_hint: 'Pins show the times the bus passes. Click for details.', selected_pickup: 'Selected pick-up', clear_sel: 'Clear', no_points_map: 'No points on the map yet.',
